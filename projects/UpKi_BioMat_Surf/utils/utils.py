...
def get_model_name_from_activites(train_activity, test_activity):
    original_name = {"levelground1": "g1", "levelground2": "g2",
                     ...
                     # ULTra-MoCap Aktivitäten
                    "AS": "AS", "CB": "CB", "EF": "EF", "ER": "ER", "OR": "OR"
                     }# das hier mit original_name.get überflüssig gemacht
    model_train_activity = []
    for activity in train_activity:
        model_train_activity.append(original_name.get(activity, activity))
    model_test_activity = []
    for activity in test_activity:
        model_test_activity.append(original_name.get(activity, activity))
