...
results_path = "/home/benedikt_nothhelfer/ba_upki_benedikt/projects/UpKi_BioMat_Surf/results"
algos = ["BiLSTM", "CNNLSTM", "Transformer"]

#Gib den Pfad zur Prediction-Datei an
pred_path = "/home/benedikt_nothhelfer/ba_upki_benedikt/projects/UpKi_BioMat_Surf/results/predictions_all/predictions_BiLSTM__lopo__sUpperThoracic-LeftUpperArm-LeftForearm-RightUpperArm-RightForearm__pad256_lr001_o3__imuFilt_osimFilt_noYScal_byVar_run09"
...
def concat_results(results_path, settings, algos=["BiLSTM", "CNNLSTM", "Transformer"]):
    out_path_metr = os.path.join(results_path, f"metrics_all/metrics_3{settings}.csv")
    out_path_pred = os.path.join(results_path, f"predictions_all/predictions_3{settings}")
