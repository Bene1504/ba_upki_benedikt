...
class ResultsCollector:
    ...
    def _overlap_mean_reconstruct(self, windows, window_size, overlap):
        """
        ...
        total_length = (n - 1) *  overlap + window_size
    ...
    '''def _overlap_mean_reconstruct(self, windows, window_size, over_stride,):
        """
        Erstellt mean werte von predoctions zu überschneidenden Zeitpunkten
        """
        n, t, j = windows.shape
        # Testweise: stride=230 als "26 Frames Hop" interpretieren
        stride = window_size - over_stride   # 256 - 230 = 26
